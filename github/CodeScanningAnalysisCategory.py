...
class CodeScanningAnalysisCategory(NonCompletableGithubObject):
    """
    This class represents CodeScanningAnalysisCategory.

    The reference can be found here
    https://docs.github.com/en/rest

    The OpenAPI schema can be found at
    - /components/schemas/code-scanning-analysis-category
