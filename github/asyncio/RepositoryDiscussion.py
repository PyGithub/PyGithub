    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "answer" in attributes:  # pragma no branch
            self._answer = self._makeClassAttribute(
                RepositoryDiscussionComment.RepositoryDiscussionComment, attributes["answer"]
            )
        ...
        if "category" in attributes:  # pragma no branch
            self._category = self._makeClassAttribute(
                RepositoryDiscussionCategory.RepositoryDiscussionCategory, attributes["category"]
            )
        ...
        if "editor" in attributes:  # pragma no branch
            self._editor = self._makeClassAttribute(NamedUser.NamedUser, attributes["editor"])
        ...
        if "repository" in attributes:  # pragma no branch
            self._repository = self._makeClassAttribute(
                Repository.Repository, as_rest_api_attributes(attributes["repository"])
            )
