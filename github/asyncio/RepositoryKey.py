...
class RepositoryKey(CompletableGithubObject):
    ...
    @property
    async def added_by(self) -> str:
        await self._completeIfNotSet(self._added_by)
    ...
    async def enabled(self) -> bool:
        await self._completeIfNotSet(self._enabled)
    ...
    async def key(self) -> str:
        await self._completeIfNotSet(self._key)
        return self._key.value

    @property
    async def last_used(self) -> datetime:
        await self._completeIfNotSet(self._last_used)
        return self._last_used.value

    @property
    async def read_only(self) -> bool:
        await self._completeIfNotSet(self._read_only)
    ...
    async def verified(self) -> bool:
        await self._completeIfNotSet(self._verified)
