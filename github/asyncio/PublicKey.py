...
class PublicKey(CompletableGithubObject):
    ...
    @property
    async def key_id(self) -> str | int:
        await self._completeIfNotSet(self._key_id)
    ...
    async def encrypt(self, unencrypted_value: str) -> str:
        return encrypt(await self.key, unencrypted_value)
