...
class Branch(NonCompletableGithubObject):
    ...
    async def get_protection(self) -> BranchProtection.BranchProtection:
        ...
        return BranchProtection.BranchProtection(self._requester, headers, data, completed=True)

    async def edit_protection(
        self,
    ...
    async def remove_protection(self) -> None:
        """
    ...
    async def get_required_status_checks(self) -> RequiredStatusChecks.RequiredStatusChecks:
        ...
        return RequiredStatusChecks.RequiredStatusChecks(self._requester, headers, data, completed=True)

    async def edit_required_status_checks(
        self,
        strict: Opt[bool] = NotSet,
        contexts: Opt[list[str]] = NotSet,
        checks: Opt[list[str | tuple[str, int]]] = NotSet,
    ...
    async def remove_required_status_checks(self) -> None:
        """
    ...
    async def get_required_pull_request_reviews(self) -> RequiredPullRequestReviews.RequiredPullRequestReviews:
        ...
        return RequiredPullRequestReviews.RequiredPullRequestReviews(self._requester, headers, data, completed=True)

    async def edit_required_pull_request_reviews(
        self,
        dismissal_users: Opt[list[str]] = NotSet,
        dismissal_teams: Opt[list[str]] = NotSet,
        dismissal_apps: Opt[list[str]] = NotSet,
    ...
    async def remove_required_pull_request_reviews(self) -> None:
        """
    ...
    async def get_admin_enforcement(self) -> bool:
        """
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{self.protection_url}/enforce_admins")
        return data["enabled"]

    async def set_admin_enforcement(self) -> None:
        """
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("POST", f"{self.protection_url}/enforce_admins")

    async def remove_admin_enforcement(self) -> None:
        """
    ...
    async def add_user_push_restrictions(self, *users: str) -> None:
        """
    ...
    async def replace_user_push_restrictions(self, *users: str) -> None:
        """
    ...
    async def remove_user_push_restrictions(self, *users: str) -> None:
        """
    ...
    async def add_team_push_restrictions(self, *teams: str) -> None:
        """
    ...
    async def replace_team_push_restrictions(self, *teams: str) -> None:
        """
    ...
    async def remove_team_push_restrictions(self, *teams: str) -> None:
        """
    ...
    async def remove_push_restrictions(self) -> None:
        """
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("DELETE", f"{self.protection_url}/restrictions")

    async def get_required_signatures(self) -> bool:
        """
    ...
    async def add_required_signatures(self) -> None:
        """
    ...
    async def remove_required_signatures(self) -> None:
        """
    ...
    async def get_allow_deletions(self) -> bool:
        """
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{self.protection_url}/allow_deletions")
        return data["enabled"]

    async def set_allow_deletions(self) -> None:
        """
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("POST", f"{self.protection_url}/allow_deletions")

    async def remove_allow_deletions(self) -> None:
        """
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("DELETE", f"{self.protection_url}/allow_deletions")

    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        if "_links" in attributes:  # pragma no branch
            self.__links = self._makeDictAttribute(attributes["_links"])
        if "commit" in attributes:  # pragma no branch
            self._commit = self._makeClassAttribute(Commit.Commit, attributes["commit"])
        ...
        if "protection" in attributes:  # pragma no branch
            self._protection = self._makeClassAttribute(BranchProtection.BranchProtection, attributes["protection"])
