...
from . import CommitStatus, Repository
...
class CommitCombinedStatus(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._statuses: Attribute[list[CommitStatus.CommitStatus]] = NotSet
    ...
    @property
    def statuses(self) -> list[CommitStatus.CommitStatus]:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "statuses" in attributes:  # pragma no branch
            self._statuses = self._makeListOfClassesAttribute(CommitStatus.CommitStatus, attributes["statuses"])
