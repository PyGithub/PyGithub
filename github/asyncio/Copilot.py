...
class Copilot(NonCompletableGithubObject):
    ...
    def __repr__(self) -> str:
        return self.get__repr__({"org_name": self._org_name.value if is_defined(self._org_name) else NotSet})
    ...
    async def add_seats(self, selected_usernames: list[str]) -> int:
        """
    ...
    async def remove_seats(self, selected_usernames: list[str]) -> int:
        """
