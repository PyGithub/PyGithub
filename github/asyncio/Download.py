...
class Download(CompletableGithubObject):
    ...
    @property
    async def accesskeyid(self) -> str:
        await self._completeIfNotSet(self._accesskeyid)
        return self._accesskeyid.value

    @property
    async def acl(self) -> str:
        await self._completeIfNotSet(self._acl)
        return self._acl.value

    @property
    async def bucket(self) -> str:
        await self._completeIfNotSet(self._bucket)
    ...
    @property
    async def expirationdate(self) -> datetime:
        await self._completeIfNotSet(self._expirationdate)
    ...
    async def mime_type(self) -> str:
        await self._completeIfNotSet(self._mime_type)
    ...
    async def policy(self) -> str:
        await self._completeIfNotSet(self._policy)
        return self._policy.value

    @property
    async def prefix(self) -> str:
        await self._completeIfNotSet(self._prefix)
        return self._prefix.value

    @property
    async def redirect(self) -> bool:
        await self._completeIfNotSet(self._redirect)
        return self._redirect.value

    @property
    async def s3_url(self) -> str:
        await self._completeIfNotSet(self._s3_url)
        return self._s3_url.value

    @property
    async def signature(self) -> str:
        await self._completeIfNotSet(self._signature)
