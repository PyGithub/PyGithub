...
class License(CompletableGithubObject):
    ...
    @property
    async def conditions(self) -> list[str]:
        await self._completeIfNotSet(self._conditions)
    ...
    async def implementation(self) -> str:
        await self._completeIfNotSet(self._implementation)
    ...
    @property
    async def limitations(self) -> list[str]:
        await self._completeIfNotSet(self._limitations)
    ...
    @property
    async def spdx_id(self) -> str:
        await self._completeIfNotSet(self._spdx_id)
