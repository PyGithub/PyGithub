...
class CopilotSeat(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._assignee: Attribute[NamedUser.NamedUser] | _NotSetType = NotSet
        self._assigning_team: Attribute[Team.Team] | _NotSetType = NotSet
    ...
    @property
    def assignee(self) -> NamedUser.NamedUser:
        return self._assignee.value

    @property
    def assigning_team(self) -> Team.Team:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "assigning_team" in attributes:
            self._assigning_team = self._makeClassAttribute(Team.Team, attributes["assigning_team"])
