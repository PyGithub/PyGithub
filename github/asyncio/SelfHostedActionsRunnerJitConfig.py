...
from . import SelfHostedActionsRunner
...
class SelfHostedActionsRunnerJitConfig(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._runner: Attribute[SelfHostedActionsRunner.SelfHostedActionsRunner] = NotSet
    ...
    @property
    def runner(self) -> SelfHostedActionsRunner.SelfHostedActionsRunner:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "runner" in attributes:  # pragma no branch
            self._runner = self._makeClassAttribute(
                SelfHostedActionsRunner.SelfHostedActionsRunner, attributes["runner"]
            )
