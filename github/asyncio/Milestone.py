...
class Milestone(CompletableGithubObject):
    ...
    @property
    async def closed_issues(self) -> int:
        await self._completeIfNotSet(self._closed_issues)
    ...
    @property
    async def due_on(self) -> datetime | None:
        await self._completeIfNotSet(self._due_on)
    ...
    async def edit(
        ...
        assert is_undefined(due_on) or isinstance(due_on, date), due_on
