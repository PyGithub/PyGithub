...
class Repository(CompletableGithubObject):
    ...
    async def _identity(self) -> str:
        if is_undefined(self._owner) or is_undefined(self._name):
            ...
            return await self.full_name
        return f"{await (await self.owner).login}/{await self.name}"

    @property
    async def allow_auto_merge(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._allow_auto_merge)
        return self._allow_auto_merge.value

    @property
    async def allow_forking(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._allow_forking)
        return self._allow_forking.value

    @property
    async def allow_merge_commit(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._allow_merge_commit)
        return self._allow_merge_commit.value

    @property
    async def allow_rebase_merge(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._allow_rebase_merge)
        return self._allow_rebase_merge.value

    @property
    async def allow_squash_merge(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._allow_squash_merge)
        return self._allow_squash_merge.value

    @property
    async def allow_update_branch(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._allow_update_branch)
        return self._allow_update_branch.value

    @property
    async def anonymous_access_enabled(self) -> bool:
        await self._completeIfNotSet(self._anonymous_access_enabled)
    ...
    async def archive_url(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._archive_url)
        return self._archive_url.value

    @property
    async def archived(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._archived)
        return self._archived.value

    @property
    async def assignees_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._assignees_url)
        return self._assignees_url.value

    @property
    async def blobs_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._blobs_url)
        return self._blobs_url.value

    @property
    async def branches_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._branches_url)
    ...
    async def clone_url(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._clone_url)
        return self._clone_url.value

    @property
    async def code_of_conduct(self) -> dict[str, Any]:
        await self._completeIfNotSet(self._code_of_conduct)
        return self._code_of_conduct.value

    @property
    async def collaborators_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._collaborators_url)
    ...
    @property
    async def compare_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._compare_url)
        return self._compare_url.value

    @property
    async def contents_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._contents_url)
        return self._contents_url.value

    @property
    async def contributors_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._contributors_url)
    ...
    @property
    async def custom_properties(self) -> dict[str, None | str | list]:
        """
        :type: dict[str, None | str | list]
        """
        await self._completeIfNotSet(self._custom_properties)
    ...
    async def default_branch(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._default_branch)
        return self._default_branch.value

    @property
    async def delete_branch_on_merge(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._delete_branch_on_merge)
        return self._delete_branch_on_merge.value

    @property
    async def deployments_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._deployments_url)
    ...
    @property
    async def disabled(self) -> bool:
        await self._completeIfNotSet(self._disabled)
        return self._disabled.value

    @property
    async def downloads_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._downloads_url)
    ...
    @property
    async def fork(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._fork)
    ...
    @property
    async def forks_count(self) -> int:
        """
        :type: integer
        """
        await self._completeIfNotSet(self._forks_count)
    ...
    async def full_name(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._full_name)
        return self._full_name.value

    @property
    async def git_commits_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._git_commits_url)
        return self._git_commits_url.value

    @property
    async def git_refs_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._git_refs_url)
        return self._git_refs_url.value

    @property
    async def git_tags_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._git_tags_url)
        return self._git_tags_url.value

    @property
    async def git_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._git_url)
        return self._git_url.value

    @property
    async def has_discussions(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._has_discussions)
        return self._has_discussions.value

    @property
    async def has_downloads(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._has_downloads)
        return self._has_downloads.value

    @property
    async def has_issues(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._has_issues)
        return self._has_issues.value

    @property
    async def has_pages(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._has_pages)
        return self._has_pages.value

    @property
    async def has_projects(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._has_projects)
        return self._has_projects.value

    @property
    async def has_wiki(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._has_wiki)
    ...
    async def homepage(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._homepage)
        return self._homepage.value

    @property
    async def hooks_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._hooks_url)
    ...
    @property
    async def is_template(self) -> bool:
        """
        :type: bool
        """
        await self._completeIfNotSet(self._is_template)
        return self._is_template.value

    @property
    async def issue_comment_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._issue_comment_url)
        return self._issue_comment_url.value

    @property
    async def issue_events_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._issue_events_url)
        return self._issue_events_url.value

    @property
    async def issues_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._issues_url)
    ...
    async def keys_url(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._keys_url)
    ...
    async def language(self) -> str:
        ...
        :type: string
        """
        await self._completeIfNotSet(self._language)
        return self._language.value

    @property
    async def languages_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._languages_url)
    ...
    @property
    async def master_branch(self) -> str:
        await self._completeIfNotSet(self._master_branch)
        return self._master_branch.value

    @property
    async def merge_commit_message(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._merge_commit_message)
        return self._merge_commit_message.value

    @property
    async def merge_commit_title(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._merge_commit_title)
        return self._merge_commit_title.value

    @property
    async def merges_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._merges_url)
        return self._merges_url.value

    @property
    async def milestones_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._milestones_url)
        return self._milestones_url.value

    @property
    async def mirror_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._mirror_url)
    ...
    @property
    async def network_count(self) -> int:
        """
        :type: integer
        """
        await self._completeIfNotSet(self._network_count)
    ...
    @property
    async def notifications_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._notifications_url)
        return self._notifications_url.value

    @property
    async def open_issues(self) -> int:
        """
        :type: integer
        """
        await self._completeIfNotSet(self._open_issues)
        return self._open_issues.value

    @property
    async def open_issues_count(self) -> int:
        """
        :type: integer
        """
        await self._completeIfNotSet(self._open_issues_count)
    ...
    @property
    async def parent(self) -> Repository:
        """
    ...
    async def private(self) -> bool:
        ...
        :type: bool
        """
        await self._completeIfNotSet(self._private)
        return self._private.value

    @property
    async def pulls_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._pulls_url)
        return self._pulls_url.value

    @property
    async def pushed_at(self) -> datetime:
        """
        :type: datetime
        """
        await self._completeIfNotSet(self._pushed_at)
        return self._pushed_at.value

    @property
    async def releases_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._releases_url)
        return self._releases_url.value

    @property
    async def role_name(self) -> str:
        await self._completeIfNotSet(self._role_name)
    ...
    async def security_and_analysis(self) -> SecurityAndAnalysis.SecurityAndAnalysis:
        ...
        """
        await self._completeIfNotSet(self._security_and_analysis)
    ...
    @property
    async def source(self) -> Repository | None:
        """
        :type: :class:`Repository`
        """
        await self._completeIfNotSet(self._source)
        return self._source.value

    @property
    async def squash_merge_commit_message(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._squash_merge_commit_message)
        return self._squash_merge_commit_message.value

    @property
    async def squash_merge_commit_title(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._squash_merge_commit_title)
        return self._squash_merge_commit_title.value

    @property
    async def ssh_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._ssh_url)
        return self._ssh_url.value

    @property
    async def stargazers_count(self) -> int:
        """
        :type: integer
        """
        await self._completeIfNotSet(self._stargazers_count)  # pragma no cover (Should be covered)
        return self._stargazers_count.value  # pragma no cover (Should be covered)

    @property
    async def stargazers_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._stargazers_url)
        return self._stargazers_url.value

    @property
    async def starred_at(self) -> str:
        await self._completeIfNotSet(self._starred_at)
    ...
    async def subscribers_count(self) -> int:
        ...
        :type: integer
        """
        await self._completeIfNotSet(self._subscribers_count)
        return self._subscribers_count.value

    @property
    async def subscribers_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._subscribers_url)
    ...
    @property
    async def svn_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._svn_url)
        return self._svn_url.value

    @property
    async def tags_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._tags_url)
        return self._tags_url.value

    @property
    async def teams_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._teams_url)
        return self._teams_url.value

    @property
    async def temp_clone_token(self) -> str:
        await self._completeIfNotSet(self._temp_clone_token)
        return self._temp_clone_token.value

    @property
    async def template_repository(self) -> Repository:
        await self._completeIfNotSet(self._template_repository)
    ...
    async def topics(self) -> list[str]:
        ...
        """
        await self._completeIfNotSet(self._topics)
        return self._topics.value

    @property
    async def trees_url(self) -> str:
        """
        :type: string
        """
        await self._completeIfNotSet(self._trees_url)
    ...
    @property
    async def use_squash_pr_title_as_default(self) -> bool:
        await self._completeIfNotSet(self._use_squash_pr_title_as_default)
        return self._use_squash_pr_title_as_default.value

    @property
    async def visibility(self) -> str:
        await self._completeIfNotSet(self._visibility)
        return self._visibility.value

    @property
    async def watchers(self) -> int:
        await self._completeIfNotSet(self._watchers)
        return self._watchers.value

    @property
    async def watchers_count(self) -> int:
        await self._completeIfNotSet(self._watchers_count)
        return self._watchers_count.value

    @property
    async def web_commit_signoff_required(self) -> bool:
        """
        :type: bool
        """
    ...
    @staticmethod
    async def as_url_param(repo: str | Repository) -> str:
        assert isinstance(repo, (str, Repository))
        if isinstance(repo, Repository):
            return await repo._identity  # type: ignore
        else:
    ...
    async def add_to_collaborators(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "PUT", f"{await self.url}/collaborators/{collaborator}", input=put_parameters
        )
    ...
    async def get_collaborator_permission(self, collaborator: str | NamedUser.NamedUser) -> str:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET",
            f"{await self.url}/collaborators/{collaborator}/permission",
        )
    ...
    async def get_collaborator_role_name(self, collaborator: str | NamedUser.NamedUser) -> str:
        ...
        _, data = await self._requester.requestJsonAndCheck(
            "GET",
            f"{await self.url}/collaborators/{collaborator}/permission",
        )
    ...
    async def remove_invitation(self, invite_id: int) -> None:
        """
    ...
    async def create_autolink(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/autolinks", input=post_parameters
        )
    ...
    async def create_git_blob(self, content: str, encoding: str) -> GitBlob.GitBlob:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/git/blobs", input=post_parameters
        )
    ...
    async def create_git_commit(
        ...
        assert isinstance(tree, (GitTree.GitTree, github.GitTree.GitTree)), tree
        assert all(
            isinstance(element, (GitCommit.GitCommit, github.GitCommit.GitCommit)) for element in parents
        ), parents
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/git/commits", input=post_parameters
        )
    ...
    async def create_git_ref(self, ref: str, sha: str) -> GitRef.GitRef:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/git/refs", input=post_parameters
        )
        return GitRef.GitRef(self._requester, headers, data, completed=True)

    # TODO: v3: reorder arguments and add default value `NotSet` where `Opt[str]`
    async def create_git_tag_and_release(
        self,
        tag: str,
        tag_message: str,
        ...
        """
        await self.create_git_tag(tag, tag_message, object, type, tagger)
        return await self.create_git_release(
            tag,
            release_name,
            release_message,
            draft,
    ...
    async def create_git_release(
        ...
        :param prerelease: bool
        :param generate_release_notes: bool
        :param target_commitish: string or :class:`Branch.Branch` or :class:`Commit.Commit` or :class:`GitCommit.GitCommit`
        :param make_latest: string
        :rtype: :class:`GitRelease.GitRelease`
        """
        ...
        assert is_optional(
            target_commitish,
            (str, Branch.Branch, Commit.Commit, GitCommit.GitCommit),
        ), target_commitish
        post_parameters = {
            "tag_name": tag,
            "draft": draft,
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/releases", input=post_parameters
        )
        return GitRelease.GitRelease(self._requester, headers, data, completed=True)
    ...
    async def generate_release_notes(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/releases/generate-notes", input=post_parameters
        )
    ...
    async def create_git_tag(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/git/tags", input=post_parameters
        )
    ...
    async def create_git_tree(
        ...
        assert is_optional(base_tree, GitTree.GitTree), base_tree
        post_parameters: dict[str, Any] = {
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/git/trees", input=post_parameters
        )
    ...
    async def create_hook(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/hooks", input=post_parameters
        )
    ...
    async def create_issue(
        ...
        :param assignees: list of string or :class:`NamedUser.NamedUser`
        :param milestone: :class:`Milestone.Milestone`
        :param labels: list of :class:`Label.Label`
        :rtype: :class:`Issue.Issue`
        """
        assert isinstance(title, str), title
        assert is_optional(body, str), body
        assert is_optional(assignee, (str, NamedUser.NamedUser)), assignee
        assert is_optional_list(assignees, (NamedUser.NamedUser, str)), assignees
        assert is_optional(milestone, Milestone.Milestone), milestone
        assert is_optional_list(labels, (Label.Label, str)), labels
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/issues", input=post_parameters
        )
    ...
    async def create_key(self, title: str, key: str, read_only: bool = False) -> RepositoryKey.RepositoryKey:
        ...
        :rtype: :class:`RepositoryKey.RepositoryKey`
        """
        assert isinstance(title, str), title
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/keys", input=post_parameters
        )
    ...
    async def create_label(self, name: str, color: str, description: Opt[str] = NotSet) -> Label.Label:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST",
            f"{await self.url}/labels",
            input=post_parameters,
            headers={"Accept": Consts.mediaTypeLabelDescriptionSearchPreview},
        )
        return Label.Label(self._requester, headers, data, completed=True)
    ...
    async def create_milestone(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/milestones", input=post_parameters
        )
    ...
    async def create_project(self, name: str, body: Opt[str] = NotSet) -> Project.Project:
        ...
        if is_defined(body):
            post_parameters["body"] = body
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/projects", headers=import_header, input=post_parameters
        )
        return Project.Project(self._requester, headers, data, completed=True)
    ...
    async def create_pull(
        ...
        *,
        ...
        assert is_optional(issue, Issue.Issue), issue
        ...
        if is_defined(issue):
            post_parameters["issue"] = await issue._identity

        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/pulls", input=post_parameters
        )
        return PullRequest.PullRequest(self._requester, headers, data, completed=True)

    async def create_repository_advisory(
        self,
        summary: str,
        description: str,
        severity_or_cvss_vector_string: str,
        cve_id: str | None = None,
        vulnerabilities: Iterable[AdvisoryVulnerability.AdvisoryVulnerabilityInput] | None = None,
        cwe_ids: Iterable[str] | None = None,
        credits: Iterable[AdvisoryCredit.AdvisoryCredit] | None = None,
        ...
        :param cve_id: string
        :param vulnerabilities: iterable of :class:`AdvisoryVulnerability.AdvisoryVulnerabilityInput`
        :param cwe_ids: iterable of string
        :param credits: iterable of :class:`AdvisoryCredit.AdvisoryCredit`
        :rtype: :class:`RepositoryAdvisory.RepositoryAdvisory`
        """
        return await self.__create_repository_advisory(
            summary=summary,
    ...
    async def __create_repository_advisory(
        self,
        summary: str,
        description: str,
        severity_or_cvss_vector_string: str,
        cve_id: str | None,
        vulnerabilities: Iterable[AdvisoryVulnerability.AdvisoryVulnerabilityInput] | None,
        cwe_ids: Iterable[str] | None,
        credits: Iterable[AdvisoryCredit.AdvisoryCredit] | None,
        ...
        if private_vulnerability_reporting:
            headers, data = await self._requester.requestJsonAndCheck(
                "POST", f"{await self.url}/security-advisories/reports", input=post_parameters
            )
        else:
            headers, data = await self._requester.requestJsonAndCheck(
                "POST", f"{await self.url}/security-advisories", input=post_parameters
            )
        return RepositoryAdvisory.RepositoryAdvisory(self._requester, headers, data)

    async def create_repository_dispatch(self, event_type: str, client_payload: Opt[dict[str, Any]] = NotSet) -> bool:
        """
        ...
        status, headers, data = await self._requester.requestJson(
            "POST", f"{await self.url}/dispatches", input=post_parameters
        )
        return status == 204
    ...
    async def create_secret(
        ...
        url = f"{await self.url}/{secret_type}/secrets/{quoted_secret_name}"
        public_key = await self.get_public_key(secret_type=secret_type)
        payload = await public_key.encrypt(unencrypted_value)
        put_parameters = {
            "key_id": (await public_key.key_id),
            "encrypted_value": payload,
        }
        await self._requester.requestJsonAndCheck("PUT", url, input=put_parameters)
    ...
    async def get_secrets(
        ...
        return PaginatedList(
            Secret.Secret,
            self._requester,
            f"{await self.url}/{secret_type}/secrets",
            None,
            attributesTransformer=PaginatedList.override_attributes(
                {"secrets_url": f"{await self.url}/{secret_type}/secrets"}
            ),
            list_item="secrets",
        )
    ...
    async def get_secret(self, secret_name: str, secret_type: str = "actions") -> Secret.Secret:
        ...
        url = f"{await self.url}/{secret_type}/secrets/{secret_name}"
        return Secret.Secret(self._requester, url=url)
    ...
    async def get_variables(self) -> PaginatedList[Variable.Variable]:
        """
        Gets all repository variables :rtype: :class:`PaginatedList` of :class:`Variable.Variable`
        """
        return PaginatedList(
            Variable.Variable,
            self._requester,
            f"{await self.url}/actions/variables",
            None,
            attributesTransformer=PaginatedList.override_attributes(
                {"variables_url": f"{await self.url}/actions/variables"}
            ),
            list_item="variables",
        )
    ...
    async def get_variable(self, variable_name: str) -> Variable.Variable:
        ...
        url = f"{await self.url}/actions/variables/{variable_name}"
        return Variable.Variable(self._requester, url=url)

    async def delete_secret(self, secret_name: str, secret_type: str = "actions") -> bool:
        """
        ...
        secret_name = urllib.parse.quote(secret_name, safe="")
        status, headers, data = await self._requester.requestJson(
            "DELETE", f"{await self.url}/{secret_type}/secrets/{secret_name}"
        )
        return status == 204

    async def delete_variable(self, variable_name: str) -> bool:
        """
        ...
        variable_name = urllib.parse.quote(variable_name, safe="")
        status, headers, data = await self._requester.requestJson(
            "DELETE", f"{await self.url}/actions/variables/{variable_name}"
        )
        return status == 204
    ...
    async def create_source_import(
        ...
        :rtype: :class:`SourceImport.SourceImport`
        """
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "PUT", f"{await self.url}/import", headers=import_header, input=put_parameters
        )

        return SourceImport.SourceImport(self._requester, headers, data, completed=False)
    ...
    async def get_archive_link(self, archive_format: str, ref: Opt[str] = NotSet) -> str:
        """
        ...
        url = f"{await self.url}/{archive_format}"
        if is_defined(ref):
    ...
    async def rename_branch(self, branch: str | Branch.Branch, new_name: str) -> bool:
        ...
        status, _, _ = await self._requester.requestJson(
            "POST", f"{await self.url}/branches/{branch}/rename", input=parameters
        )
        return status == 201
    ...
    async def get_branches(self) -> PaginatedList[Branch.Branch]:
        ...
        """
        return PaginatedList(Branch.Branch, self._requester, f"{await self.url}/branches", None)
    ...
    async def get_collaborators(
        ...
        return PaginatedList(
            NamedUser.NamedUser,
            self._requester,
            f"{await self.url}/collaborators",
            url_parameters,
        )
    ...
    async def get_commits(
        ...
        :param author: string or :class:`NamedUser.NamedUser` or :class:`AuthenticatedUser.AuthenticatedUser`
        ...
        assert is_optional(
            author,
            (str, NamedUser.NamedUser, AuthenticatedUser.AuthenticatedUser),
        ), author
    ...
    async def get_contents(
        ...
        :param path: string
        :param ref: string
        :rtype: :class:`ContentFile.ContentFile` or a list of them
        """
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET",
            f"{await self.url}/contents/{urllib.parse.quote(path)}",
        ...
        if isinstance(data, list):
            return [
                ...
                ContentFile.ContentFile(self._requester, headers, item, completed=(item["type"] != "file"))
                for item in data
            ]
    ...
    async def get_deployments(
        ...
        :rtype: :class:`PaginatedList` of :class:`Deployment.Deployment`
        """
        assert is_optional(sha, str), sha
        assert is_optional(ref, str), ref
    ...
    async def get_deployment(self, id_: int) -> Deployment.Deployment:
        ...
        :param: id: int
        :rtype: :class:`Deployment.Deployment`
        """
        assert isinstance(id_, int), id_
        url = f"{await self.url}/deployments/{id_}"
        return Deployment.Deployment(self._requester, url=url, accept=Consts.deploymentEnhancementsPreview)
    ...
    async def create_deployment(
        ...
        return Deployment.Deployment(self._requester, headers, data, completed=True)
    ...
    async def get_discussion(
        ...
        variables = {
            "repo": await self.name,
            "owner": await (await self.owner).login,
            "number": number,
        }
        return await self._requester.graphql_query_class(
            query, variables, ["repository", "discussion"], RepositoryDiscussion.RepositoryDiscussion
        )
    ...
    async def get_top_referrers(self) -> None | list[Referrer.Referrer]:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/traffic/popular/referrers")
        if isinstance(data, list):
    ...
    async def get_top_paths(self) -> None | list[Path.Path]:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/traffic/popular/paths")
        if isinstance(data, list):
    ...
    async def get_views_traffic(self, per: Opt[str] = NotSet) -> View.View | None:
        ...
        :rtype: None or list of :class:`View.View`
        """
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/traffic/views", parameters=url_parameters
        )
    ...
    async def get_clones_traffic(self, per: Opt[str] = NotSet) -> Clones.Clones | None:
        ...
        :param per: string, must be one of day or week, day by default
        :rtype: None or list of :class:`Clones.Clones`
        """
        assert per in ["day", "week", NotSet], "per must be day or week, day by default"
        url_parameters: dict[str, Any] = NotSet.remove_unset_items({"per": per})
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/traffic/clones", parameters=url_parameters
        )
    ...
    async def get_autolinks(self) -> PaginatedList[Autolink.Autolink]:
        ...
        """
        return PaginatedList(Autolink.Autolink, self._requester, f"{await self.url}/autolinks", None)
    ...
    async def create_file(
        ...
        return {
            "content": ContentFile.ContentFile(self._requester, headers, data["content"], completed=False),
            "commit": Commit.Commit(self._requester, headers, data["commit"], completed=True),
        }

    async def get_repository_advisories(
        self,
    ) -> PaginatedList[RepositoryAdvisory.RepositoryAdvisory]:
        """
        :calls: `GET /repos/{owner}/{repo}/security-advisories <https://docs.github.com/en/rest/security-advisories/repository-advisories>`_
        :rtype: :class:`PaginatedList` of :class:`RepositoryAdvisory.RepositoryAdvisory`
        """
        return PaginatedList(
            RepositoryAdvisory.RepositoryAdvisory,
            self._requester,
            f"{await self.url}/security-advisories",
            None,
        )

    async def get_repository_advisory(self, ghsa: str) -> RepositoryAdvisory.RepositoryAdvisory:
        """
        ...
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/security-advisories/{ghsa}")
        return RepositoryAdvisory.RepositoryAdvisory(self._requester, headers, data)
    ...
    async def delete_file(
        ...
        :param author: InputGitAuthor, (optional), if omitted this will be filled in with committer information. If
            passed, you must specify both a name and email.
        :rtype: { 'content': :class:`null <NotSet>`:, 'commit': :class:`Commit <Commit.Commit>`}
    ...
    async def get_events(self) -> PaginatedList[Event.Event]:
        ...
        """
        return PaginatedList(Event.Event, self._requester, f"{await self.url}/events", None)

    async def get_forks(self) -> PaginatedList[Repository]:
        """
        ...
        """
        return PaginatedList(Repository, self._requester, f"{await self.url}/forks", None)
    ...
    async def create_fork(
        ...
        :param organization: :class:`Organization.Organization` or string
        :param name: string
    ...
    async def get_git_matching_refs(self, ref: str) -> PaginatedList[GitRef.GitRef]:
        ...
        return PaginatedList(
            GitRef.GitRef,
            self._requester,
            f"{await self.url}/git/matching-refs/{ref}",
            None,
        )
    ...
    async def get_git_tree(self, sha: str, recursive: Opt[bool] = NotSet) -> GitTree.GitTree:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/git/trees/{sha}", parameters=url_parameters
        )
        return GitTree.GitTree(self._requester, headers, data, completed=True)
    ...
    async def get_hooks(self) -> PaginatedList[Hook.Hook]:
        ...
        """
        return PaginatedList(Hook.Hook, self._requester, f"{await self.url}/hooks", None)

    async def get_hook_delivery(self, hook_id: int, delivery_id: int) -> HookDelivery.HookDelivery:
        """
        ...
        :rtype: :class:`HookDelivery.HookDelivery`
        """
        assert isinstance(hook_id, int), hook_id
        assert isinstance(delivery_id, int), delivery_id
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/hooks/{hook_id}/deliveries/{delivery_id}"
        )
        return HookDelivery.HookDelivery(self._requester, headers, data)

    async def get_hook_deliveries(self, hook_id: int) -> PaginatedList[HookDelivery.HookDeliverySummary]:
        """
        :calls: `GET /repos/{owner}/{repo}/hooks/{hook_id}/deliveries <https://docs.github.com/en/rest/webhooks/repo-deliveries>`_
        :param hook_id: integer
        :rtype: :class:`PaginatedList` of :class:`HookDelivery.HookDeliverySummary`
        """
        assert isinstance(hook_id, int), hook_id
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/hooks/{hook_id}/deliveries",
            None,
        )
    ...
    async def get_issue(self, number: int) -> Issue.Issue:
        ...
        """
        assert isinstance(number, int), number
        url = f"{await self.url}/issues/{number}"
        return Issue.Issue(self._requester, url=url)
    ...
    async def get_issues(
        ...
        :param assignee: string or :class:`NamedUser.NamedUser` or "none" or "*"
        :param mentioned: :class:`NamedUser.NamedUser`
        :param labels: list of string or :class:`Label.Label`
        :param sort: string
        :param direction: string
        :param since: datetime
        :param creator: string or :class:`NamedUser.NamedUser`
        :param type: string
        :rtype: :class:`PaginatedList` of :class:`Issue.Issue`
        """
        assert milestone in ["*", "none", NotSet] or isinstance(
            milestone, (Milestone.Milestone, github.Milestone.Milestone)
        ), milestone
        assert is_optional(state, str), state
        assert is_optional(assignee, (str, NamedUser.NamedUser)), assignee
        assert is_optional(type, str), type
        assert is_optional(mentioned, NamedUser.NamedUser), mentioned
        assert is_optional_list(labels, (Label.Label, str)), labels
        ...
        if is_defined(creator):
            if isinstance(creator, str):
                ...
                url_parameters["creator"] = await creator._identity
        return PaginatedList(Issue.Issue, self._requester, f"{await self.url}/issues", url_parameters)
    ...
    async def get_issues_comments(
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/issues/comments",
            url_parameters,
        )
    ...
    async def get_issues_event(self, id: int) -> IssueEvent.IssueEvent:
        ...
        :param id: integer
        :rtype: :class:`IssueEvent.IssueEvent`
        """
        assert isinstance(id, int), id
        headers, data = await self._requester.requestJsonAndCheck(
            "GET",
            f"{await self.url}/issues/events/{id}",
    ...
    async def get_issues_events(self) -> PaginatedList[IssueEvent.IssueEvent]:
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/issues/events",
            None,
            headers={"Accept": Consts.mediaTypeLockReasonPreview},
        )
    ...
    async def get_milestone(self, number: int) -> Milestone.Milestone:
        ...
        """
        assert isinstance(number, int), number
        url = f"{await self.url}/milestones/{number}"
        return Milestone.Milestone(self._requester, url=url)
    ...
    async def get_network_events(self) -> PaginatedList[Event.Event]:
        ...
        return PaginatedList(
            Event.Event,
            self._requester,
            f"/networks/{await (await self.owner).login}/{await self.name}/events",
            None,
        )
    ...
    async def get_public_key(self, secret_type: str = "actions") -> PublicKey.PublicKey:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/{secret_type}/secrets/public-key"
        )
    ...
    async def get_pull(self, number: int) -> PullRequest.PullRequest:
        ...
        """
        assert isinstance(number, int), number
        url = f"{await self.url}/pulls/{number}"
    ...
    async def get_pulls(
        ...
        return PaginatedList(
            PullRequest.PullRequest,
            self._requester,
            f"{await self.url}/pulls",
            url_parameters,
        )

    async def get_pulls_comments(
        self,
        sort: Opt[str] = NotSet,
        direction: Opt[str] = NotSet,
        since: Opt[datetime] = NotSet,
        ...
        :param direction: string
        :param since: datetime
        :rtype: :class:`PaginatedList` of :class:`PullRequestComment.PullRequestComment`
        """
        return await self.get_pulls_review_comments(sort, direction, since)

    async def get_pulls_review_comments(
        self,
        sort: Opt[str] = NotSet,
        direction: Opt[str] = NotSet,
        since: Opt[datetime] = NotSet,
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/pulls/comments",
            url_parameters,
        )
    ...
    async def get_readme(self, ref: Opt[str] = NotSet) -> ContentFile.ContentFile:
        ...
        if is_defined(ref):
            url_parameters["ref"] = ref
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/readme", parameters=url_parameters
        )
        return ContentFile.ContentFile(self._requester, headers, data, completed=True)
    ...
    async def get_self_hosted_runner(self, runner_id: int) -> SelfHostedActionsRunner.SelfHostedActionsRunner:
        ...
        :param runner_id: int
        :rtype: :class:`SelfHostedActionsRunner.SelfHostedActionsRunner`
        """
        assert isinstance(runner_id, int), runner_id
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/actions/runners/{runner_id}"
        )
    ...
    async def get_self_hosted_runners(self) -> PaginatedList[SelfHostedActionsRunner.SelfHostedActionsRunner]:
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/actions/runners",
            None,
            list_item="runners",
        )
    ...
    async def get_stats_contributors(self) -> list[StatsContributor.StatsContributor] | None:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/stats/contributors")
        if not data:
            return None
        else:
    ...
    async def get_stats_commit_activity(self) -> list[StatsCommitActivity.StatsCommitActivity] | None:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/stats/commit_activity")
        if not data:
            return None
        else:
            return [
    ...
    async def get_stats_code_frequency(self) -> list[StatsCodeFrequency.StatsCodeFrequency] | None:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/stats/code_frequency")
        if not data:
            return None
        else:
    ...
    async def get_stats_participation(self) -> StatsParticipation.StatsParticipation | None:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/stats/participation")
        if not data:
            return None
        else:
    ...
    async def get_stats_punch_card(self) -> StatsPunchCard.StatsPunchCard | None:
        ...
        """
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/stats/punch_card")
        if not data:
            return None
        else:
    ...
    async def get_release(self, id: int | str) -> GitRelease.GitRelease:
        ...
        :rtype: None or :class:`GitRelease.GitRelease`
        """
    ...
    async def get_teams(self) -> PaginatedList[Team.Team]:
        ...
        """
        return PaginatedList(Team.Team, self._requester, f"{await self.url}/teams", None)
    ...
    async def get_workflows(self) -> PaginatedList[Workflow.Workflow]:
        ...
        return PaginatedList(
            Workflow.Workflow,
            self._requester,
            f"{await self.url}/actions/workflows",
            None,
            list_item="workflows",
        )
    ...
    async def get_workflow(self, id_or_file_name: str | int) -> Workflow.Workflow:
        ...
        url = f"{await self.url}/actions/workflows/{id_or_file_name}"
        return Workflow.Workflow(self._requester, url=url)
    ...
    async def get_workflow_runs(
        ...
        :rtype: :class:`PaginatedList` of :class:`WorkflowRun.WorkflowRun`
        """
        assert is_optional(actor, (NamedUser.NamedUser, str)), actor
        assert is_optional(branch, (Branch.Branch, str)), branch
    ...
    async def get_workflow_run(self, id_: int) -> WorkflowRun.WorkflowRun:
        ...
        :param id_: int
        :rtype: :class:`WorkflowRun.WorkflowRun`
        """
    ...
    async def has_in_assignees(self, assignee: str | NamedUser.NamedUser) -> bool:
        ...
        :rtype: bool
        """
        assert isinstance(assignee, (NamedUser.NamedUser, github.NamedUser.NamedUser)) or isinstance(
            assignee, str
        ), assignee
    ...
    async def has_in_collaborators(self, collaborator: str | NamedUser.NamedUser) -> bool:
        ...
        status, headers, data = await self._requester.requestJson(
            "GET", f"{await self.url}/collaborators/{collaborator}"
        )
        return status == 204
    ...
    async def legacy_search_issues(self, state: str, keyword: str) -> list[Issue.Issue]:
        ...
        :rtype: List of :class:`Issue.Issue`
        """
        assert state in ["open", "closed"], state
        assert isinstance(keyword, str), keyword
        headers, data = await self._requester.requestJsonAndCheck(
            "GET",
            f"/legacy/issues/search/{await (await self.owner).login}/{await self.name}/{state}/{urllib.parse.quote(keyword, safe='')}",
        )
        return [
            Issue.Issue(
                self._requester,
    ...
    async def get_notifications(
        ...
        :rtype: :class:`PaginatedList` of :class:`Notification.Notification`
        """
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/notifications",
            params,
        )

    async def mark_notifications_as_read(self, last_read_at: datetime = datetime.now(timezone.utc)) -> None:
        """
    ...
    async def merge(self, base: str, head: str, commit_message: Opt[str] = NotSet) -> Commit.Commit | None:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/merges", input=post_parameters
        )
        if data is None:
            return None
        else:
    ...
    async def merge_upstream(self, branch: str) -> MergedUpstream.MergedUpstream:
        ...
        :param branch: string
        :rtype: :class:`MergedUpstream.MergedUpstream`
        :raises: :class:`GithubException` for error status codes
        """
        assert isinstance(branch, str), branch
        post_parameters = {"branch": branch}
        headers, data = await self._requester.requestJsonAndCheck(
            "POST", f"{await self.url}/merge-upstream", input=post_parameters
        )
        return MergedUpstream.MergedUpstream(self._requester, headers, data)
    ...
    async def get_vulnerability_alert(self) -> bool:
        """
        ...
        status, _, _ = await self._requester.requestJson(
            "GET",
            f"{await self.url}/vulnerability-alerts",
            headers={"Accept": Consts.vulnerabilityAlertsPreview},
        )
        return status == 204

    async def enable_vulnerability_alert(self) -> bool:
        """
    ...
    async def disable_vulnerability_alert(self) -> bool:
        """
    ...
    async def get_automated_security_fixes(self) -> dict[str, bool]:
        """
        ...
        _, data = await self._requester.requestJsonAndCheck(
            "GET",
            f"{await self.url}/automated-security-fixes",
            headers={"Accept": Consts.automatedSecurityFixes},
        )
        return data

    async def enable_automated_security_fixes(self) -> bool:
        """
    ...
    async def disable_automated_security_fixes(self) -> bool:
        """
    ...
    async def remove_autolink(self, autolink: Autolink.Autolink | int) -> bool:
        ...
        status, _, _ = await self._requester.requestJson(
            "DELETE", f"{await self.url}/autolinks/{autolink.id if is_autolink else autolink}"  # type: ignore
        )
        return status == 204

    async def subscribe_to_hub(self, event: str, callback: str, secret: Opt[str] = NotSet) -> None:
        """
        ...
        :rtype: None
        """
        return await self._hub("subscribe", event, callback, secret)

    async def unsubscribe_from_hub(self, event: str, callback: str) -> None:
        """
        :calls: `POST /hub <https://docs.github.com/en/rest/reference/repos#pubsubhubbub>`_
        :param event: string
        :param callback: string
    ...
    async def create_check_suite(self, head_sha: str) -> CheckSuite.CheckSuite:
        ...
        :param head_sha: string
        :rtype: :class:`CheckSuite.CheckSuite`
        """
        assert isinstance(head_sha, str), head_sha
        headers, data = await self._requester.requestJsonAndCheck(
            "POST",
            f"{await self.url}/check-suites",
    ...
    async def get_check_suite(self, check_suite_id: int) -> CheckSuite.CheckSuite:
        ...
        url = f"{await self.url}/check-suites/{check_suite_id}"
        return CheckSuite.CheckSuite(self._requester, url=url, accept="application/vnd.github.v3+json")
    ...
    async def update_check_suites_preferences(
        ...
        :rtype: :class:`RepositoryPreferences.RepositoryPreferences`
        """
        assert all(isinstance(element, dict) for element in auto_trigger_checks), auto_trigger_checks
        headers, data = await self._requester.requestJsonAndCheck(
            "PATCH",
            f"{await self.url}/check-suites/preferences",
            input={"auto_trigger_checks": auto_trigger_checks},
        )
        return RepositoryPreferences.RepositoryPreferences(self._requester, headers, data)

    async def _hub(self, mode: str, event: str, callback: str, secret: Opt[str]) -> None:
        ...
        post_parameters["hub.topic"] = f"https://github.com/{await self.full_name}/events/{event}"
    ...
    async def get_artifacts(self, name: Opt[str] = NotSet) -> PaginatedList[Artifact.Artifact]:
        ...
        :param name: str
        :rtype: :class:`PaginatedList` of :class:`Artifact.Artifact`
        """
        ...
        return PaginatedList(
            Artifact.Artifact,
            self._requester,
            f"{await self.url}/actions/artifacts",
            firstParams=param,
            list_item="artifacts",
        )
    ...
    async def get_artifact(self, artifact_id: int) -> Artifact.Artifact:
        ...
        :rtype: :class:`Artifact.Artifact`
        """
        assert isinstance(artifact_id, int), artifact_id
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/actions/artifacts/{artifact_id}"
        )
        return Artifact.Artifact(self._requester, headers, data)

    async def get_codescan_alerts(
        self,
        ...
        :rtype: :class:`PaginatedList` of :class:`CodeScanAlert.CodeScanAlert`
        """
        ...
        assert is_undefined(tool_name) or is_undefined(
            tool_guid
        ...
        return PaginatedList(
            CodeScanAlert.CodeScanAlert,
            self._requester,
            f"{await self.url}/code-scanning/alerts",
            url_parameters,
        )
    ...
    async def get_codescan_alert(self, number: int) -> CodeScanAlert.CodeScanAlert:
        ...
        :param number: int
        :rtype: :class:`CodeScanAlert.CodeScanAlert`
        """
        assert isinstance(number, int), number
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/code-scanning/alerts/{number}"
        )
        return CodeScanAlert.CodeScanAlert(self._requester, headers, data)
    ...
    async def get_secret_scanning_alerts(
        ...
        :rtype: :class:`PaginatedList` of :class:`SecretScanAlert.SecretScanAlert`
        """
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/secret-scanning/alerts",
            url_parameters,
        )
    ...
    async def get_secret_scanning_alert(
        ...
        :param number: int
        :param hide_secret: Optional bool
        :rtype: :class:`SecretScanAlert.SecretScanAlert`
        """
        assert isinstance(number, int), number
        assert is_optional(hide_secret, bool), hide_secret
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/secret-scanning/alerts/{number}", parameters=query_parameters
        )
    ...
    async def get_environments(self) -> PaginatedList[Environment.Environment]:
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/environments",
            None,
            attributesTransformer=PaginatedList.override_attributes(
                {"environments_url": f"/repositories/{await self.id}/environments"}
            ),
    ...
    async def get_environment(self, environment_name: str) -> Environment.Environment:
        ...
        url = f"{await self.url}/environments/{environment_name}"
        return Environment.Environment(self._requester, url=url)
    ...
    async def create_environment(
        ...
        :param reviewers: List[:class:EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams]
        :param prevent_self_review: bool
        :param deployment_branch_policy: Optional[:class:EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams`]
        :rtype: :class:`Environment.Environment`
        """
        assert isinstance(environment_name, str), environment_name
        ...
        assert (
            isinstance(
                ...
                (
                    EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams,
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "PUT", f"{await self.url}/environments/{environment_name}", input=put_parameters
        )
        if "url" not in data:
            data["url"] = f"{await self.url}/environments/{environment_name}"
        return Environment.Environment(self._requester, headers, data, completed=True)

    async def delete_environment(self, environment_name: str) -> None:
        """
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "DELETE", f"{await self.url}/environments/{environment_name}"
        )
    ...
    async def get_dependabot_alerts(
        ...
        :param sort: Optional string
        :param direction: Optional string
        :rtype: :class:`PaginatedList` of :class:`DependabotAlert.DependabotAlert`
        """
        ...
        return PaginatedList(
            ...
            self._requester,
            f"{await self.url}/dependabot/alerts",
            url_parameters,
        )
    ...
    async def get_dependabot_alert(self, number: int) -> DependabotAlert.DependabotAlert:
        ...
        :param number: int
        :rtype: :class:`DependabotAlert.DependabotAlert`
        """
        assert isinstance(number, int), number
        headers, data = await self._requester.requestJsonAndCheck("GET", f"{await self.url}/dependabot/alerts/{number}")
        return DependabotAlert.DependabotAlert(self._requester, headers, data)
    ...
    async def update_dependabot_alert(
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "PATCH",
            f"{await self.url}/dependabot/alerts/{number}",
    ...
    async def get_custom_properties(self) -> dict[str, None | str | list]:
        """
        ...
        """
        url = f"{await self.url}/properties/values"
        _, data = await self._requester.requestJsonAndCheck("GET", url)
    ...
    async def update_custom_properties(self, properties: dict[str, None | str | list]) -> None:
        """
        ...
        await self._requester.requestJsonAndCheck("PATCH", url, input=patch_parameters)

    async def attach_security_config(self, id: int) -> None:
        """
        ...
        await (await self.organization).attach_security_config_to_repositories(
            id=id, scope="selected", selected_repository_ids=[await self.id]
        )

    async def detach_security_config(self) -> None:
        """
    ...
    async def get_security_config(self) -> RepoCodeSecurityConfig.RepoCodeSecurityConfig | None:
        ...
        headers, data = await self._requester.requestJsonAndCheck(
            "GET", f"{await self.url}/code-security-configuration"
        )
        if data is None:
            return None
        return RepoCodeSecurityConfig.RepoCodeSecurityConfig(self._requester, headers, data)
    ...
    async def transfer_ownership(
        ...
        _, _ = await self._requester.requestJsonAndCheck("POST", f"{await self.url}/transfer", input=post_parameters)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "license" in attributes:  # pragma no branch
            self._license = self._makeClassAttribute(License.License, attributes["license"])
        ...
        if "security_and_analysis" in attributes:  # pragma no branch
            self._security_and_analysis = self._makeClassAttribute(
                SecurityAndAnalysis.SecurityAndAnalysis, attributes["security_and_analysis"]
            )
