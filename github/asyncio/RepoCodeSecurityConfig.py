...
from . import CodeSecurityConfig
...
class RepoCodeSecurityConfig(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._configuration: Attribute[CodeSecurityConfig.CodeSecurityConfig] = NotSet
    ...
    @property
    def configuration(self) -> CodeSecurityConfig.CodeSecurityConfig:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        if "configuration" in attributes:  # pragma no branch
            self._configuration = self._makeClassAttribute(
                CodeSecurityConfig.CodeSecurityConfig, attributes["configuration"]
            )
