...
class Authorization(GithubObject.CompletableGithubObject):
    ...
    @property
    async def note(self) -> str | None:
        await self._completeIfNotSet(self._note)
        return self._note.value

    @property
    async def note_url(self) -> str | None:
        await self._completeIfNotSet(self._note_url)
        return self._note_url.value

    @property
    async def scopes(self) -> str:
        await self._completeIfNotSet(self._scopes)
        return self._scopes.value

    @property
    async def token(self) -> str:
        await self._completeIfNotSet(self._token)
