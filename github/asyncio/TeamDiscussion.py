...
class TeamDiscussion(DiscussionBase):
    ...
    @property
    async def body_version(self) -> str:
        await self._completeIfNotSet(self._body_version)
        return self._body_version.value

    @property
    async def comments_count(self) -> int:
        await self._completeIfNotSet(self._comments_count)
    ...
    async def pinned(self) -> bool:
        await self._completeIfNotSet(self._pinned)
    ...
    @property
    async def team_url(self) -> str:
        await self._completeIfNotSet(self._team_url)
