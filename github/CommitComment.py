...
class CommitComment(github.GithubObject.CompletableGithubObject):
    ...
    def delete(self):
        """
        :calls: `DELETE /repos/:owner/:repo/comments/:id <http://developer.github.com/v3/todo>`_
        :rtype: None
        """
    ...
    def edit(self, body):
        """
        :calls: `PATCH /repos/:owner/:repo/comments/:id <http://developer.github.com/v3/todo>`_
        :param body: string
        :rtype: None
        """
