...
class Event(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._org: Attribute[Organization.Organization] = NotSet
        self._payload: Attribute[dict[str, Any]] = NotSet
        self._public: Attribute[bool] = NotSet
        self._repo: Attribute[Repository.Repository] = NotSet
    ...
    @property
    def org(self) -> Organization.Organization:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "org" in attributes:  # pragma no branch
            self._org = self._makeClassAttribute(Organization.Organization, attributes["org"])
        ...
        if "repo" in attributes:  # pragma no branch
            self._repo = self._makeClassAttribute(Repository.Repository, attributes["repo"])
