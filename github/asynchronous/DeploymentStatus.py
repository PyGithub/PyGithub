...
from . import GithubApp, NamedUser, Organization
...
class DeploymentStatus(CompletableGithubObject):
    ...
    async def deployment_url(self) -> str:
        await self._completeIfNotSet(self._deployment_url)
    ...
    @property
    async def environment_url(self) -> str:
        await self._completeIfNotSet(self._environment_url)
    ...
    @property
    async def log_url(self) -> str:
        await self._completeIfNotSet(self._log_url)
    ...
    async def target_url(self) -> str:
        await self._completeIfNotSet(self._target_url)
