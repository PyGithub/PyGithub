...
class GitTag(CompletableGithubObject):
    ...
    async def tag(self) -> str:
        await self._completeIfNotSet(self._tag)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "object" in attributes:  # pragma no branch
            self._object = self._makeClassAttribute(GitObject.GitObject, attributes["object"])
        ...
        if "tagger" in attributes:  # pragma no branch
            self._tagger = self._makeClassAttribute(GitAuthor.GitAuthor, attributes["tagger"])
