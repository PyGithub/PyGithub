...
class GithubApp(CompletableGithubObject):
    ...
    async def client_id(self) -> str:
        await self._completeIfNotSet(self._client_id)
        return self._client_id.value

    @property
    async def client_secret(self) -> str:
        await self._completeIfNotSet(self._client_secret)
    ...
    @property
    async def external_url(self) -> str:
        await self._completeIfNotSet(self._external_url)
    ...
    @property
    async def installations_count(self) -> int:
        await self._completeIfNotSet(self._installations_count)
    ...
    @property
    async def pem(self) -> str:
        await self._completeIfNotSet(self._pem)
        return self._pem.value

    @property
    async def permissions(self) -> dict[str, str]:
    ...
    async def webhook_secret(self) -> str:
        await self._completeIfNotSet(self._webhook_secret)
