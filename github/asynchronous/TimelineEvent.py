...
class TimelineEvent(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._source: Attribute[TimelineEventSource.TimelineEventSource] = NotSet
    ...
    @property
    def actor(self) -> NamedUser.NamedUser:
        return self._actor.value

    @property
    def author_association(self) -> str | None:
        if self.event == "commented" and is_defined(self._author_association):
            return self._author_association.value
        return None

    @property
    def body(self) -> str | None:
        if self.event == "commented" and is_defined(self._body):
    ...
    @property
    def source(self) -> TimelineEventSource.TimelineEventSource | None:
        # only available on `cross-referenced` events.
        if self.event == "cross-referenced" and is_defined(self._source):
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "source" in attributes:  # pragma no branch
            self._source = self._makeClassAttribute(TimelineEventSource.TimelineEventSource, attributes["source"])
