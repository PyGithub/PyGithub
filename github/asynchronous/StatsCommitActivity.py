...
class StatsCommitActivity(GithubObject.NonCompletableGithubObject):
    """
    ...
    def _initAttributes(self) -> None:
        self._days: Attribute[int] = GithubObject.NotSet
        self._total: Attribute[int] = GithubObject.NotSet
        self._week: Attribute[datetime] = GithubObject.NotSet
