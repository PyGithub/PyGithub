...
class PullRequestComment(CompletableGithubObject):
    ...
    async def commit_id(self) -> str:
        await self._completeIfNotSet(self._commit_id)
    ...
    @property
    async def diff_hunk(self) -> str:
        await self._completeIfNotSet(self._diff_hunk)
    ...
    @property
    async def in_reply_to_id(self) -> int:
        await self._completeIfNotSet(self._in_reply_to_id)
        return self._in_reply_to_id.value

    @property
    async def line(self) -> int:
        await self._completeIfNotSet(self._line)
    ...
    @property
    async def original_commit_id(self) -> str:
        await self._completeIfNotSet(self._original_commit_id)
        return self._original_commit_id.value

    @property
    async def original_line(self) -> int:
        await self._completeIfNotSet(self._original_line)
        return self._original_line.value

    @property
    async def original_position(self) -> int:
        await self._completeIfNotSet(self._original_position)
        return self._original_position.value

    @property
    async def original_start_line(self) -> int:
        await self._completeIfNotSet(self._original_start_line)
    ...
    async def position(self) -> int:
        await self._completeIfNotSet(self._position)
        return self._position.value

    @property
    async def pull_request_review_id(self) -> int:
        await self._completeIfNotSet(self._pull_request_review_id)
        return self._pull_request_review_id.value

    @property
    async def pull_request_url(self) -> str:
        await self._completeIfNotSet(self._pull_request_url)
    ...
    async def side(self) -> str:
        await self._completeIfNotSet(self._side)
        return self._side.value

    @property
    async def start_line(self) -> int:
        await self._completeIfNotSet(self._start_line)
        return self._start_line.value

    @property
    async def start_side(self) -> str:
        await self._completeIfNotSet(self._start_side)
        return self._start_side.value

    @property
    async def subject_type(self) -> str:
        await self._completeIfNotSet(self._subject_type)
    ...
    async def get_reactions(self) -> PaginatedList[Reaction.Reaction]:
        ...
        :return: :class: :class:`PaginatedList` of :class:`Reaction.Reaction`
        """
