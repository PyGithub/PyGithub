...
class OrganizationSecret(Secret):
    ...
    @property
    async def selected_repositories_url(self) -> str:
        await self._completeIfNotSet(self._selected_repositories_url)
    ...
    async def add_repo(self, repo: Repository) -> bool:
        """
    ...
    async def remove_repo(self, repo: Repository) -> bool:
        """
