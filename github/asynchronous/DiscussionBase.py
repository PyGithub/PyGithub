...
from . import GithubObject, NamedUser
...
class DiscussionBase(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._author: Attribute[NamedUser.NamedUser | None] = NotSet
    ...
    @property
    async def author(self) -> NamedUser.NamedUser | None:
    ...
    @property
    async def last_edited_at(self) -> datetime:
        await self._completeIfNotSet(self._last_edited_at)
