...
class PullRequest(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._assignees: Attribute[list[NamedUser] | None] = NotSet
        ...
        self._requested_reviewers: Attribute[list[NamedUser] | None] = NotSet
        self._requested_teams: Attribute[list[Team] | None] = NotSet
    ...
    @property
    def assignees(self) -> list[NamedUser] | None:
    ...
    @property
    def requested_reviewers(self) -> list[NamedUser] | None:
        self._completeIfNotSet(self._requested_reviewers)
        return self._requested_reviewers.value

    @property
    def requested_teams(self) -> list[Team] | None:
