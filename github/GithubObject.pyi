...
class CompletableGithubObject:
    def __eq__(
        self,
        other: Union[GitRelease, PullRequestReview, str, Organization]
    ) -> bool: ...
    def __init__(
        self,
        requester: Requester,
    ...
    def __ne__(self, other: NamedUser) -> bool: ...
...
class GithubObject:
    ...
    def get__repr__(self, params: Dict[str, Union[int, NamedUser, str, Commit]]) -> str: ...
    @property
