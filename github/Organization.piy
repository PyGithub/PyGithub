...
class Organization:
    ...
    def add_to_members(self, member: NamedUser, role: str = ...) -> None: ...
    ...
    def create_migration(
        self,
        repos: List[str],
        lock_repositories: _NotSetType = ...,
        exclude_attachments: _NotSetType = ...
    ) -> Migration: ...
    def create_repo(
        self,
        name: str,
    ...
    def get_migrations(self) -> PaginatedList: ...
    def get_outside_collaborators(
        self,
        filter_: _NotSetType = ...
    ) -> PaginatedList: ...
    def get_projects(self, state: str = ...) -> PaginatedList: ...
    def get_public_members(self) -> PaginatedList: ...
    ...
    @property
    def two_factor_requirement_enabled(self) -> None: ...
    @property
    def type(self) -> str: ...
    @property
