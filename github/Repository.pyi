...
class Repository(CompletableGithubObject):
    ...
    def list_repository_secrets(self) -> PaginatedList[Secret]: ...
    ...
    def get_code_scanning_analyses(self) -> PaginatedList[CodeScanningAnalysis]: ...
    ...
    def get_workflow_job(self, job_id: Union[str, int]) -> Job: ...
