...
class AuthenticatedUser(CompletableGithubObject):
    ...
    def get_authorizations(self) -> PaginatedList: ...
    def get_emails(self) -> List[str]: ...
    def get_events(self) -> PaginatedList: ...
    def get_followers(self) -> PaginatedList: ...
    def get_following(self) -> PaginatedList: ...
    def get_gists(self, since: Union[datetime, _NotSetType] = ...) -> PaginatedList: ...
    def get_invitations(self) -> PaginatedList: ...
    def get_issues(
        self,
    ...
    def get_organization_events(self, org: Organization) -> PaginatedList: ...
    ...
    def get_starred_gists(self) -> PaginatedList: ...
