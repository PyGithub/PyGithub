...
class Repository(github.GithubObject.CompletableGithubObject):
    ...
    def add_to_collaborators(self, collaborator, permission=github.GithubObject.NotSet):
        ...
        :rtype: None
        """
        assert isinstance(collaborator, github.NamedUser.NamedUser) or isinstance(collaborator, six.string_types), collaborator
        assert permission is github.GithubObject.NotSet or isinstance(permission, six.string_types), permission
    ...
    def compare(self, base, head):
        ...
        """
        assert isinstance(base, six.string_types), base
        assert isinstance(head, six.string_types), head
        headers, data = self._requester.requestJsonAndCheck(
            "GET",
    ...
    def create_git_blob(self, content, encoding):
        ...
        assert isinstance(encoding, six.string_types), encoding
        post_parameters = {
            "content": content,
            "encoding": encoding,
        }
    ...
    def create_git_release(self, tag, name, message, draft=False, prerelease=False, target_commitish=github.GithubObject.NotSet):
        ...
        """
        assert isinstance(tag, six.string_types), tag
        assert isinstance(name, six.string_types), name
        assert isinstance(message, six.string_types), message
        assert isinstance(draft, bool), draft
        assert isinstance(prerelease, bool), prerelease
        assert target_commitish is github.GithubObject.NotSet or isinstance(target_commitish, (six.string_types, github.Branch.Branch, github.Commit.Commit, github.GitCommit.GitCommit)), target_commitish
        post_parameters = {
            "tag_name": tag,
            "name": name,
            "body": message,
        ...
        if isinstance(target_commitish, six.string_types):
    ...
    def create_git_tag(self, tag, message, object, type, tagger=github.GithubObject.NotSet):
        ...
        assert isinstance(tag, six.string_types), tag
        assert isinstance(message, six.string_types), message
        assert isinstance(object, six.string_types), object
        assert isinstance(type, six.string_types), type
    ...
    def create_issue(self, title, body=github.GithubObject.NotSet, assignee=github.GithubObject.NotSet, milestone=github.GithubObject.NotSet, labels=github.GithubObject.NotSet, assignees=github.GithubObject.NotSet):
        ...
        assert assignee is github.GithubObject.NotSet or isinstance(assignee, github.NamedUser.NamedUser) or isinstance(assignee, six.string_types), assignee
        assert assignees is github.GithubObject.NotSet or all(isinstance(element, github.NamedUser.NamedUser) or isinstance(element, six.string_types) for element in assignees), assignees
        assert milestone is github.GithubObject.NotSet or isinstance(milestone, github.Milestone.Milestone), milestone
        assert labels is github.GithubObject.NotSet or all(isinstance(element, github.Label.Label) or isinstance(element, six.string_types) for element in labels), labels
        ...
        if assignee is not github.GithubObject.NotSet:
            if isinstance(assignee, six.string_types):
    ...
    def create_source_import(self, vcs, vcs_url, vcs_username=github.GithubObject.NotSet, vcs_password=github.GithubObject.NotSet):
        ...
        """
        assert isinstance(vcs, six.string_types), vcs
        assert isinstance(vcs_url, six.string_types), vcs_url
        assert vcs_username is github.GithubObject.NotSet or isinstance(vcs_username, six.string_types), vcs_username
        assert vcs_password is github.GithubObject.NotSet or isinstance(vcs_password, six.string_types), vcs_password
        put_parameters = {
            "vcs": vcs,
            "vcs_url": vcs_url
        }
    ...
    def edit(self, name=None, description=github.GithubObject.NotSet, homepage=github.GithubObject.NotSet, private=github.GithubObject.NotSet, has_issues=github.GithubObject.NotSet, has_projects=github.GithubObject.NotSet, has_wiki=github.GithubObject.NotSet, has_downloads=github.GithubObject.NotSet, default_branch=github.GithubObject.NotSet, allow_squash_merge=github.GithubObject.NotSet, allow_merge_commit=github.GithubObject.NotSet, allow_rebase_merge=github.GithubObject.NotSet, archived=github.GithubObject.NotSet):
        ...
        assert default_branch is github.GithubObject.NotSet or isinstance(default_branch, six.string_types), default_branch
    ...
    def get_archive_link(self, archive_format, ref=github.GithubObject.NotSet):
        ...
        :rtype: string
        """
        assert isinstance(archive_format, six.string_types), archive_format
        assert ref is github.GithubObject.NotSet or isinstance(ref, six.string_types), ref
    ...
    def get_branch(self, branch):
        ...
        """
        assert isinstance(branch, six.string_types), branch
        headers, data = self._requester.requestJsonAndCheck(
            "GET",
    ...
    def get_commits(self, sha=github.GithubObject.NotSet, path=github.GithubObject.NotSet, since=github.GithubObject.NotSet, until=github.GithubObject.NotSet, author=github.GithubObject.NotSet):
        ...
        assert author is github.GithubObject.NotSet or isinstance(author, (six.string_types, github.NamedUser.NamedUser, github.AuthenticatedUser.AuthenticatedUser)), author
        url_parameters = dict()
    ...
    def get_views_traffic(self, per=github.GithubObject.NotSet):
        ...
        """
        assert per is github.GithubObject.NotSet or (isinstance(per, six.string_types) and (per == "day" or per == "week")), "per must be day or week, day by default"
        url_parameters = dict()
    ...
    def create_file(self, path, message, content,
        ...
        assert isinstance(content, (six.string_types, bytes)),         \
            'content must be a str/unicode object'
        assert branch is github.GithubObject.NotSet                \
            or isinstance(branch, six.string_types),                 \
    ...
    def update_file(self, path, message, content, sha,
        ...
        assert isinstance(content, (six.string_types, bytes)),         \
            'content must be a str/unicode object'
        assert isinstance(sha, six.string_types),                    \
    ...
    def get_issues(self, milestone=github.GithubObject.NotSet, state=github.GithubObject.NotSet, assignee=github.GithubObject.NotSet, mentioned=github.GithubObject.NotSet, labels=github.GithubObject.NotSet, sort=github.GithubObject.NotSet, direction=github.GithubObject.NotSet, since=github.GithubObject.NotSet, creator=github.GithubObject.NotSet):
        ...
        assert since is github.GithubObject.NotSet or isinstance(since, datetime.datetime), since
        assert creator is github.GithubObject.NotSet or isinstance(creator, github.NamedUser.NamedUser) or isinstance(creator, six.string_types), creator
        url_parameters = dict()
        if milestone is not github.GithubObject.NotSet:
            if isinstance(milestone, six.string_types):
    ...
    def get_pulls(self, state=github.GithubObject.NotSet, sort=github.GithubObject.NotSet, direction=github.GithubObject.NotSet, base=github.GithubObject.NotSet, head=github.GithubObject.NotSet):
        ...
        assert head is github.GithubObject.NotSet or isinstance(head, six.string_types), head
        url_parameters = dict()
        if state is not github.GithubObject.NotSet:
            url_parameters["state"] = state
        if sort is not github.GithubObject.NotSet:
    ...
    def has_in_assignees(self, assignee):
        ...
        :rtype: bool
        """
        assert isinstance(assignee, github.NamedUser.NamedUser) or isinstance(assignee, six.string_types), assignee
    ...
    def _hub(self, mode, event, callback, secret):
        assert isinstance(mode, six.string_types), mode
        assert isinstance(event, six.string_types), event
        assert isinstance(callback, six.string_types), callback
        assert secret is github.GithubObject.NotSet or isinstance(secret, six.string_types), secret
