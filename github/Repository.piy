...
class Repository:
    ...
    def create_source_import(
        ...
        vcs: str,
        vcs_url: str,
        vcs_username: _NotSetType = ...,
        vcs_password: _NotSetType = ...
    ) -> SourceImport: ...
    @property
    ...
    def get_assignees(self) -> PaginatedList: ...
    def get_branch(self, branch: str) -> Branch: ...
    def get_clones_traffic(
        self,
        per: _NotSetType = ...
    ) -> Dict[str, Union[int, List[Clones]]]: ...
    def get_collaborator_permission(self, collaborator: str) -> str: ...
    ...
    def get_contributors(self, anon: _NotSetType = ...) -> PaginatedList: ...
    ...
    def get_downloads(self) -> PaginatedList: ...
    ...
    def get_git_refs(self) -> PaginatedList: ...
    def get_git_tag(self, sha: str) -> GitTag: ...
    def get_git_tree(
        self,
        sha: str,
        recursive: Union[bool, _NotSetType] = ...
    ) -> GitTree: ...
    def get_hook(self, id: int) -> Hook: ...
    def get_hooks(self) -> PaginatedList: ...
    ...
    def get_issues_events(self) -> PaginatedList: ...
    ...
    def get_network_events(self) -> PaginatedList: ...
    def get_pending_invitations(self) -> PaginatedList: ...
    def get_projects(
        self,
        state: Union[str, _NotSetType] = ...
    ) -> PaginatedList: ...
    ...
    def get_releases(self) -> PaginatedList: ...
    def get_source_import(self) -> SourceImport: ...
    def get_stargazers(self) -> PaginatedList: ...
    def get_stargazers_with_dates(self) -> PaginatedList: ...
    def get_stats_code_frequency(self) -> List[StatsCodeFrequency]: ...
    def get_stats_commit_activity(self) -> List[StatsCommitActivity]: ...
    def get_stats_contributors(self) -> List[StatsContributor]: ...
    def get_stats_participation(self) -> StatsParticipation: ...
    def get_stats_punch_card(self) -> StatsPunchCard: ...
    def get_subscribers(self) -> PaginatedList: ...
    def get_tags(self) -> PaginatedList: ...
    def get_teams(self) -> PaginatedList: ...
    ...
    def get_watchers(self) -> PaginatedList: ...
    @property
