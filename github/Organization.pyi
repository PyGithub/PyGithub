...
class Organization(CompletableGithubObject):
    ...
    def create_or_update_secret(
        ...
        secret_value: str,
        visibility: str,
        selected_repository_ids: Optional[List[str]] = None
    ) -> bool: ...
    def get_secret(self, secret_name) -> Secret: ...
    def get_secrets(self) -> PaginatedList[Secret]: ...
    def list_secret_selected_repositories(self, secret_name: str) -> PaginatedList[Repository]: ...
    def set_secret_selected_repositories(self, secret_name: str, selected_repository_ids: List[str]) -> None: ...
    def add_secret_selected_repository(self, secret_name: str, repository_id: str) -> None: ...
    def remove_secret_selected_repository(self, secret_name: str, repository_id: str) -> None: ...
