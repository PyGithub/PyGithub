...
class AuthenticatedUser(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.user.created_at, datetime.datetime(2010, 7, 9, 6, 10, 6).replace(tzinfo=Framework.getUTCtzinfo()))
    ...
    def testGetNotification(self):
        ...
        self.assertEqual(notification.updated_at, datetime.datetime(2013, 3, 15, 5, 43, 11).replace(tzinfo=Framework.getUTCtzinfo()))
