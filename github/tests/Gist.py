...
class Gist(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(gist.created_at, datetime.datetime(
            2013, 8, 21, 16, 28, 24))
        ...
        self.assertEqual(gist.files["GithubAPI.lua"].content[
                         :10], "-- GithubA")
        self.assertEqual(gist.files["GithubAPI.lua"].raw_url,
        ...
        self.assertEqual(gist.history[0].committed_at,
                         datetime.datetime(2013, 8, 21, 16, 12, 27))
        self.assertEqual(gist.history[
                         0].url, "https://api.github.com/gists/6296732/c464aecd7fea16684e935607eeea7ae4f8caa0e2")
        ...
        self.assertEqual(gist.updated_at, datetime.datetime(
            2013, 8, 21, 16, 28, 24))
    ...
    def testEditWithoutParameters(self):
        ...
        self.assertEqual(
            gist.updated_at, datetime.datetime(2012, 5, 19, 7, 0, 58))
    ...
    def testEditWithAllParameters(self):
        ...
        self.assertEqual(
            gist.updated_at, datetime.datetime(2012, 5, 19, 7, 6, 10))
    ...
    def testRenameFile(self):
        gist = self.g.get_gist("5339374")
        self.assertEqual(gist.files.keys(), ["bar.txt"])
        gist.edit(files={"bar.txt": github.InputFileContent(
