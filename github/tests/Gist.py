...
class Gist(Framework.TestCase):
    def testAttributes(self):
        ...
        self.assertEqual(gist.created_at, datetime.datetime(2013, 8, 21, 16, 28, 24).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(gist.history[0].committed_at, datetime.datetime(2013, 8, 21, 16, 12, 27).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(gist.updated_at, datetime.datetime(2013, 8, 21, 16, 28, 24).replace(tzinfo=Framework.getUTCtzinfo()))
    ...
    def testEditWithoutParameters(self):
        ...
        self.assertEqual(gist.updated_at, datetime.datetime(2012, 5, 19, 7, 0, 58).replace(tzinfo=Framework.getUTCtzinfo()))
    ...
    def testEditWithAllParameters(self):
        ...
        self.assertEqual(gist.updated_at, datetime.datetime(2012, 5, 19, 7, 6, 10).replace(tzinfo=Framework.getUTCtzinfo()))
