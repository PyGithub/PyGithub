...
class Event(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.event.__repr__(),
                         'Event(type="PushEvent", id="1556114751")')
