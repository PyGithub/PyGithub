...
class Repository(Framework.TestCase):
    ...
    def testCreateKeyReadOnly(self):
        key = self.repo.create_key("Key added through PyGithub", "ssh-rsa  vincent@IDEE", True)
        self.assertEqual(key.id, 2626761)
