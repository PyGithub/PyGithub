...
class PullRequestComment(Framework.TestCase):
    ...
    def setUp(self):
        ...
        self.comment = self.g.get_user().get_repo(
            "PyGithub").get_pull(31).get_comment(886298)
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.comment.created_at,
                         datetime.datetime(2012, 5, 27, 9, 40, 12))
        ...
        self.assertEqual(self.comment.updated_at,
                         datetime.datetime(2012, 5, 27, 9, 40, 12))
        self.assertEqual(
            self.comment.url, "https://api.github.com/repos/jacquev6/PyGithub/pulls/comments/886298")
