...
class PullRequestComment(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.comment.created_at, datetime.datetime(2012, 5, 27, 9, 40, 12).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.comment.updated_at, datetime.datetime(2012, 5, 27, 9, 40, 12).replace(tzinfo=Framework.getUTCtzinfo()))
