...
class Milestone(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.milestone.created_at,
                         datetime.datetime(2012, 3, 8, 12, 22, 10))
        self.assertEqual(self.milestone.description, "")
        self.assertEqual(self.milestone.due_on,
                         datetime.datetime(2012, 3, 13, 7, 0, 0))
        ...
        self.assertEqual(
            self.milestone.url, "https://api.github.com/repos/jacquev6/PyGithub/milestones/1")
    ...
    def testEditWithAllParameters(self):
        self.milestone.edit("Title edited twice by PyGithub", "closed",
                            "Description edited by PyGithub", due_on=datetime.date(2012, 6, 16))
        ...
        self.assertEqual(self.milestone.due_on,
                         datetime.datetime(2012, 6, 16, 7, 0, 0))

    def testGetLabels(self):
        self.assertListKeyEqual(self.milestone.get_labels(), lambda l: l.name, [
