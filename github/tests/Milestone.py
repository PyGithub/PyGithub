...
class Milestone(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.milestone.created_at, datetime.datetime(2012, 3, 8, 12, 22, 10).replace(tzinfo=Framework.getUTCtzinfo()))
        self.assertEqual(self.milestone.description, "")
        self.assertEqual(self.milestone.due_on, datetime.datetime(2012, 3, 13, 7, 0, 0).replace(tzinfo=Framework.getUTCtzinfo()))
    ...
    def testEditWithAllParameters(self):
        ...
        self.assertEqual(self.milestone.due_on, datetime.datetime(2012, 6, 16, 7, 0, 0).replace(tzinfo=Framework.getUTCtzinfo()))
