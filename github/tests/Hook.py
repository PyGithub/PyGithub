...
class Hook(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.hook.created_at,
                         datetime.datetime(2012, 5, 19, 6, 1, 45))
    ...
    def testEditWithMinimalParameters(self):
        ...
        self.assertEqual(self.hook.updated_at,
                         datetime.datetime(2012, 5, 19, 5, 8, 16))
    ...
    def testEditWithAllParameters(self):
        self.hook.edit("web", {"url": "http://foobar.com"},
                       events=["fork", "push"])
        self.assertEqual(self.hook.events, ["fork", "push"])
        self.hook.edit(
            "web", {"url": "http://foobar.com"}, add_events=["push"])
        self.assertEqual(self.hook.events, ["fork", "push"])
        self.hook.edit("web", {"url": "http://foobar.com"},
                       remove_events=["fork"])
        self.assertEqual(self.hook.events, ["push"])
