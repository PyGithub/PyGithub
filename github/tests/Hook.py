...
class Hook(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.hook.created_at, datetime.datetime(2012, 5, 19, 6, 1, 45).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.hook.updated_at, datetime.datetime(2012, 5, 29, 18, 49, 47).replace(tzinfo=Framework.getUTCtzinfo()))
    ...
    def testEditWithMinimalParameters(self):
        ...
        self.assertEqual(self.hook.updated_at, datetime.datetime(2012, 5, 19, 5, 8, 16).replace(tzinfo=Framework.getUTCtzinfo()))
