...
class GitCommit(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.commit.author.date, datetime.datetime(2012, 4, 17, 17, 55, 16).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.commit.committer.date, datetime.datetime(2012, 4, 17, 17, 55, 16).replace(tzinfo=Framework.getUTCtzinfo()))
