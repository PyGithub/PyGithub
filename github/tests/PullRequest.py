...
class PullRequest(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.pull.closed_at, datetime.datetime(2012, 5, 27, 10, 29, 7).replace(tzinfo=Framework.getUTCtzinfo()))
        self.assertEqual(self.pull.comments, 1)
        self.assertEqual(self.pull.commits, 3)
        self.assertEqual(self.pull.created_at, datetime.datetime(2012, 5, 27, 9, 25, 36).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.pull.merged_at, datetime.datetime(2012, 5, 27, 10, 29, 7).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.pull.updated_at, datetime.datetime(2012, 11, 3, 8, 19, 40).replace(tzinfo=Framework.getUTCtzinfo()))
