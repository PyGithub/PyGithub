...
class Authorization(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.authorization.created_at, datetime.datetime(2012, 5, 22, 18, 3, 17).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.authorization.updated_at, datetime.datetime(2012, 5, 22, 18, 3, 17).replace(tzinfo=Framework.getUTCtzinfo()))
