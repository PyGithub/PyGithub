...
class Issue(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.issue.closed_at, datetime.datetime(2012, 5, 26, 14, 59, 33).replace(tzinfo=Framework.getUTCtzinfo()))
        self.assertEqual(self.issue.closed_by.login, "jacquev6")
        self.assertEqual(self.issue.comments, 0)
        self.assertEqual(self.issue.created_at, datetime.datetime(2012, 5, 19, 10, 38, 23).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.issue.updated_at, datetime.datetime(2012, 5, 26, 14, 59, 33).replace(tzinfo=Framework.getUTCtzinfo()))
