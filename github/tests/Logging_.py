...
class Logging(Framework.BasicTestCase):
    ...
    def testLoggingWithBasicAuthentication(self):
        self.assertEqual(github.Github(
            self.login, self.password).get_user().name, "Vincent Jacques")
    ...
    def testLoggingWithOAuthAuthentication(self):
        self.assertEqual(github.Github(
            self.oauth_token).get_user().name, "Vincent Jacques")
        if atMostPython32:
    ...
    def testLoggingWithoutAuthentication(self):
        self.assertEqual(github.Github().get_user(
            "jacquev6").name, "Vincent Jacques")
        if atMostPython32:
    ...
    def testLoggingWithBaseUrl(self):
        ...
        self.assertEqual(github.Github(
            base_url="http://my.enterprise.com/my/prefix").get_user("jacquev6").name, "Vincent Jacques")
        if atMostPython32:
