...
class CommitCombinedStatus(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.combined_status.statuses[4].created_at, datetime.datetime(2015, 12, 14, 13, 24, 18).replace(tzinfo=Framework.getUTCtzinfo()))
        self.assertEqual(self.combined_status.statuses[3].updated_at, datetime.datetime(2015, 12, 14, 13, 23, 35).replace(tzinfo=Framework.getUTCtzinfo()))
