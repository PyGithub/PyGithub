...
class CommitComment(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.comment.created_at, datetime.datetime(2012, 5, 22, 18, 40, 18).replace(tzinfo=Framework.getUTCtzinfo()))
        ...
        self.assertEqual(self.comment.updated_at, datetime.datetime(2012, 5, 22, 18, 40, 18).replace(tzinfo=Framework.getUTCtzinfo()))
