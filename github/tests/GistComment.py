...
class GistComment(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.comment.created_at, datetime.datetime(2012, 5, 19, 7, 7, 57).replace(tzinfo=Framework.getUTCtzinfo()))
        self.assertEqual(self.comment.id, 323629)
        self.assertEqual(self.comment.updated_at, datetime.datetime(2012, 5, 19, 7, 7, 57).replace(tzinfo=Framework.getUTCtzinfo()))
    ...
    def testEdit(self):
        ...
        self.assertEqual(self.comment.updated_at, datetime.datetime(2012, 5, 19, 7, 12, 32).replace(tzinfo=Framework.getUTCtzinfo()))
