...
class Issue140(Framework.TestCase):  # https://github.com/jacquev6/PyGithub/issues/140
    ...
    def testGetFileContents(self):
        ...
        self.assertEqual(
            contents.url, "https://api.github.com/repos/twitter/bootstrap/contents/js/bootstrap-affix.js")
        self.assertEqual(len(contents.content), 4722)

    def testGetDirContentsWithRef(self):
        self.assertEqual(len(self.repo.get_dir_contents(
            "/js", "8c7f9c66a7d12f47f50618ef420868fe836d0c33")), 15)
