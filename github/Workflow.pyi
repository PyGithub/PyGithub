...
class Workflow(CompletableGithubObject):
    ...
    def create_dispatch(
        ...
        inputs: Union[Dict[str, Union[str, int, float]], NotSetType] = ...,
    ) -> bool: ...
    def get_runs(
        self,
        actor: Union[str, NamedUser, NotSetType] = ...,
        branch: Union[str, Branch, NotSetType] = ...,
        event: Union[str, NotSetType] = ...,
        status: Union[str, NotSetType] = ...,
