...
from PyGithub.Blocking.tests.old_classes.AuthenticatedUserTestCase import *
from PyGithub.Blocking.tests.old_classes.CommitTestCase import *
...
from PyGithub.Blocking.tests.old_classes.SubscriptionTestCase import *
