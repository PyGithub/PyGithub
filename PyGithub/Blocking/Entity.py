...
class Entity(PyGithub.Blocking.BaseGithubObject.UpdatableGithubObject):
    ...
    class Plan(PyGithub.Blocking.BaseGithubObject.SessionedGithubObject):
        ...
        def _initAttributes(self, collaborators=None, name=None, private_repos=None, space=None, **kwds):
            ...
            self.__collaborators = self._createIntAttribute("Entity.Plan.collaborators", collaborators)
            self.__name = self._createStringAttribute("Entity.Plan.name", name)
            self.__private_repos = self._createIntAttribute("Entity.Plan.private_repos", private_repos)
            self.__space = self._createIntAttribute("Entity.Plan.space", space)
    ...
    def _initAttributes(self, avatar_url=PyGithub.Blocking.Attributes.Absent, blog=PyGithub.Blocking.Attributes.Absent, collaborators=PyGithub.Blocking.Attributes.Absent, company=PyGithub.Blocking.Attributes.Absent, created_at=PyGithub.Blocking.Attributes.Absent, disk_usage=PyGithub.Blocking.Attributes.Absent, email=PyGithub.Blocking.Attributes.Absent, events_url=PyGithub.Blocking.Attributes.Absent, followers=PyGithub.Blocking.Attributes.Absent, following=PyGithub.Blocking.Attributes.Absent, html_url=PyGithub.Blocking.Attributes.Absent, id=PyGithub.Blocking.Attributes.Absent, location=PyGithub.Blocking.Attributes.Absent, login=PyGithub.Blocking.Attributes.Absent, name=PyGithub.Blocking.Attributes.Absent, owned_private_repos=PyGithub.Blocking.Attributes.Absent, plan=PyGithub.Blocking.Attributes.Absent, private_gists=PyGithub.Blocking.Attributes.Absent, public_gists=PyGithub.Blocking.Attributes.Absent, public_repos=PyGithub.Blocking.Attributes.Absent, repos_url=PyGithub.Blocking.Attributes.Absent, total_private_repos=PyGithub.Blocking.Attributes.Absent, type=PyGithub.Blocking.Attributes.Absent, updated_at=PyGithub.Blocking.Attributes.Absent, url=PyGithub.Blocking.Attributes.Absent, **kwds):
        ...
        self.__avatar_url = self._createStringAttribute("Entity.avatar_url", avatar_url)
        self.__blog = self._createStringAttribute("Entity.blog", blog)
        self.__collaborators = self._createIntAttribute("Entity.collaborators", collaborators)
        self.__company = self._createStringAttribute("Entity.company", company)
        self.__created_at = self._createDatetimeAttribute("Entity.created_at", created_at)
        self.__disk_usage = self._createIntAttribute("Entity.disk_usage", disk_usage)
        self.__email = self._createStringAttribute("Entity.email", email)
        self.__events_url = self._createStringAttribute("Entity.events_url", events_url)
        self.__followers = self._createIntAttribute("Entity.followers", followers)
        self.__following = self._createIntAttribute("Entity.following", following)
        self.__html_url = self._createStringAttribute("Entity.html_url", html_url)
        self.__id = self._createIntAttribute("Entity.id", id)
        self.__location = self._createStringAttribute("Entity.location", location)
        self.__login = self._createStringAttribute("Entity.login", login)
        self.__name = self._createStringAttribute("Entity.name", name)
        self.__owned_private_repos = self._createIntAttribute("Entity.owned_private_repos", owned_private_repos)
        self.__plan = self._createStructAttribute("Entity.plan", Entity.Plan, plan)
        self.__private_gists = self._createIntAttribute("Entity.private_gists", private_gists)
        self.__public_gists = self._createIntAttribute("Entity.public_gists", public_gists)
        self.__public_repos = self._createIntAttribute("Entity.public_repos", public_repos)
        self.__repos_url = self._createStringAttribute("Entity.repos_url", repos_url)
        self.__total_private_repos = self._createIntAttribute("Entity.total_private_repos", total_private_repos)
        self.__type = self._createStringAttribute("Entity.type", type)
        self.__updated_at = self._createDatetimeAttribute("Entity.updated_at", updated_at)
        self.__url = self._createStringAttribute("Entity.url", url)
