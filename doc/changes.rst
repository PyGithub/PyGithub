...
Version 2.7.0 (Juli 31, 2025)
-----------------------------------

* Normalize App ID to String & Enhance JWT Issuer Verification (#3272) (01196d67)
* Add support for Sub-Issues (#3258) (c7858c85)
* Make `TimingData.run_duration_ms` optional (#3268) (131949b3)
* Fix side-effect when removing Authorization key from headers (#3313) (0378ccee)
* Fix url encoding of strings with slashes in URLs (#3263) (da73fc8a)
* Adds `multi_select` and `true_false` options to `CustomProperty.value_type` (#3173) (f51a3f48)
* Relax 404 condition in `Requester` exception handling (#3299) (e7110bf4)
* Support built-in `reversed()` on `PaginatedList` (#3260) (95f015c8)
* Add `PullRequest.get_issue_timeline` method (#3259) (23a5bad3)
* Adding `prevent_self_review` property to `Repository.createEnvironment` (#3246) (e2a05ff2)
* Get collaborator role name (#3295) (2d4785dd)
* CI: Disable OpenAPI workflow on forks (03e47ae2)
* Apply OpenAPI spec (#3317) (858b9e5b)
* Allow SHAs when creating PR comments (#3248) (95a6d400)
* Add getting list of self-hosted runners of organization (#3190) (b4092b5d)
* Bump actions/checkout from 3 to 4 (#2754) (3657eeb9)
* Create codeql.yml (#3277) (78267263)
* fix(CodeScanAlert): add missing attributes (#3274) (bdc58c38)
* Enhance PyGithub webhook documentation (#3267) (63438b6a)
* Replace `deprecated.deprecated()` with `typing_extensions.deprecated()` (#3255) (1ac8da70)
* Add Python 3.13 to CI (#3253) (29e8a96b)
* Add `Organization.get_repos_for_code_security_config` test (#3239) (4d45a4f4)
* Make token auth default in tests (#3242) (7a11f840)
* Sync with OpenAPI spec (#3244) (5cef2c3d)
* Fix return type of `PaginatedList[int]` (#3240) (8aa27d4b)
* Move all Python files to future annotations (#3241) (3602345a)
* Sync `Team` class with API spec (#3237) (fa8f9dfe)
* Sync `RequiredStatusChecks` class with API spec (#3236) (0474507f)
* Sync `RequiredPullRequestReviews` class with API spec (#3234) (2f991c48)
* Sync `HookDeliverySummary` class with API spec (#3233) (bc1c5375)
* Sync `CopilotSeat` class with API spec (#3232) (45f26a1b)
* Sort classes' functions (#3231) (bb00062d)
* Fix `Branch.get_required_status_checks` return type (#3235) (66a3cc1c)
* Add `CodeSecurityConfigRepository` returned by `get_repos_for_code_security_config` (#3219) (dbb32eed)
* Make `GitTag.verification` return `GitCommitVerification` (#3226) (850932cc)
* Fix incorrect deprecated import (#3225) (a2071d70)
* Remove schema from `Deployment`, remove `message` attribute (#3223) (e91713e9)
* Rename `HookDeliveryRequest` and `…Response` private headers fields (#3221) (13236d5d)
* Remove wrong schema from Repository (#3220) (aee3a350)
* Fix broken pickle support for `Auth` classes (#3211) (a1f328df)
* Mention removal of `AppAuth.private_key` in changelog (#3212) (fae8f25d)
* Sync `ProjectColumn` and `ProjectCard` tests with OpenAPI spec (#3216) (e91c8379)
* Sync `RepositoryAdvisory` tests with OpenAPI spec (#3215) (6b77787a)
* Add and apply missing schemas (#3209) (f4d586b4)
* Remove error schemas from classes (#3202) (6ea33845)
* Add `OrganizationInvitation` (#3207) (038624c2)
* Make `Github.get_rate_limit()` return `RateLimitOverview` (#3205) (56ee057a)
* Add schema to `TimingData` (#3206) (20b8c477)
* Refactor search results into separate classes (#3204) (938f80b1)
