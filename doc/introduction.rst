...
* `check-in <https://github.com/webknjaz/check-in>`_ (`pip install <https://pypi.org/p/check-in>`_) — Python CLI distribution that allows user to use GitHub Checks API as a bot.
