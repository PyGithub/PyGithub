...
You need to use a Github API and wonder which class implements it? `Reference of APIs <todo internal link>`__

You want all the details about PyGithub classes? `Reference of classes <todo internal link>`__
