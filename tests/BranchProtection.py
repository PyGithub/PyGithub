...
class BranchProtection(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.branch_protection.block_creations, {'enabled': False})
        ...
        self.assertEqual(self.branch_protection.required_signatures, {'url': 'https://api.github.com/repos/curvewise-forks/PyGithub/branches/master/protection/required_signatures', 'enabled': False})
