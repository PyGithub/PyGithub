...
class PublicKey(Framework.TestCase):
    def testAttributes(self):
        ...
        self.assertEqual(self.public_key.created_at, "")
        self.assertEqual(self.public_key.id, 0)
        ...
        self.assertEqual(self.public_key.title, "")
        self.assertEqual(self.public_key.url, "")
