...
class Team(Framework.TestCase):
    ...
    def testAttributes(self):
        self.assertIsNone(self.team.created_at)
        self.assertIsNone(self.team.description)
        ...
        self.assertIsNone(self.team.members_url)
        self.assertEqual(self.team.name, "Team created by PyGithub")
        self.assertIsNone(self.team.node_id)
        self.assertIsNone(self.team.notification_setting)
        ...
        self.assertIsNone(self.team.repositories_url)
        self.assertEqual(self.team.slug, 'pygithub')
        self.assertIsNone(self.team.updated_at)
