...
class PullRequestComment(Framework.TestCase):
    ...
    def testAttributes(self):
        self.assertEqual(self.comment._links, {'self': {'href': 'https://api.github.com/repos/jacquev6/PyGithub/pulls/comments/886298'}, 'html': {'href': 'https://github.com/jacquev6/PyGithub/pull/31#r886298'}, 'pull_request': {'href': 'https://api.github.com/repos/jacquev6/PyGithub/pulls/31'}})
        ...
        self.assertIsNone(self.comment.diff_hunk)
        ...
        self.assertIsNone(self.comment.line)
        ...
        self.assertIsNone(self.comment.pull_request_url)
        self.assertIsNone(self.comment.reactions)
        self.assertIsNone(self.comment.side)
        self.assertIsNone(self.comment.start_line)
        self.assertIsNone(self.comment.start_side)
        self.assertIsNone(self.comment.subject_type)
        self.assertEqual(
