...
class Organization(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertIsNone(self.org.is_verified)
        ...
        self.assertIsNone(self.org.members_allowed_repository_creation_type)
        self.assertIsNone(self.org.members_can_create_internal_repositories)
        self.assertIsNone(self.org.members_can_create_pages)
        self.assertIsNone(self.org.members_can_create_private_pages)
        self.assertIsNone(self.org.members_can_create_private_repositories)
        self.assertIsNone(self.org.members_can_create_public_pages)
        self.assertIsNone(self.org.members_can_create_public_repositories)
        self.assertFalse(self.org.members_can_create_repositories)
        self.assertIsNone(self.org.members_can_fork_private_repositories)
        ...
        self.assertIsNone(self.org.node_id)
        ...
        self.assertEqual(self.org.public_members_url, 'https://api.github.com/orgs/BeaverSoftware/public_members{/member}')
        ...
        self.assertEqual(self.org.updated_at, datetime(2017, 10, 24, 12, 11, 24, tzinfo=timezone.utc))
        ...
        self.assertIsNone(self.org.web_commit_signoff_required)
