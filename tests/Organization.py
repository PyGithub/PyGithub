...
class Organization(Framework.TestCase):
    ...
    def testAttributes(self):
        self.assertEqual(self.org.advanced_security_enabled_for_new_repositories, False)
        self.assertEqual(self.org.archived_at, datetime(2020, 1, 2, 12, 34, 56, tzinfo=timezone.utc))
        ...
        self.assertEqual(self.org.dependabot_alerts_enabled_for_new_repositories, False)
        self.assertEqual(self.org.dependabot_security_updates_enabled_for_new_repositories, False)
        self.assertEqual(self.org.dependency_graph_enabled_for_new_repositories, False)
        self.assertEqual(self.org.description, "BeaverSoftware writes software.")
        self.assertEqual(self.org.disk_usage, 2)
        self.assertEqual(self.org.display_login, "")
        self.assertEqual(self.org.email, "")
        self.assertEqual(self.org.events_url, "")
        ...
        self.assertEqual(self.org.members_allowed_repository_creation_type, "")
        self.assertEqual(self.org.members_can_create_internal_repositories, False)
        self.assertEqual(self.org.members_can_create_pages, False)
        self.assertEqual(self.org.members_can_create_private_pages, False)
        self.assertEqual(self.org.members_can_create_private_repositories, False)
        self.assertEqual(self.org.members_can_create_public_pages, False)
        ...
        self.assertEqual(self.org.members_url, "")
        self.assertEqual(self.org.name, "BeaverSoftware")
        self.assertEqual(self.org.node_id, "")
        ...
        self.assertEqual(self.org.public_members_url, "")
        self.assertEqual(self.org.public_repos, 27)
        self.assertEqual(self.org.repos_url, "")
        self.assertEqual(self.org.secret_scanning_enabled_for_new_repositories, False)
        self.assertEqual(self.org.secret_scanning_push_protection_custom_link, "")
        self.assertEqual(self.org.secret_scanning_push_protection_custom_link_enabled, False)
        self.assertEqual(self.org.secret_scanning_push_protection_enabled_for_new_repositories, False)
        self.assertEqual(self.org.total_private_repos, 7)
        self.assertEqual(self.org.twitter_username, "")
        self.assertEqual(self.org.two_factor_requirement_enabled, None)
        self.assertEqual(self.org.type, "Organization")
        self.assertEqual(self.org.updated_at, datetime(2020, 1, 2, 12, 34, 56, tzinfo=timezone.utc))
