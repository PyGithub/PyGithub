...
class AuthenticatedUser(Framework.TestCase):
    ...
    def testGetNotification(self):
        ...
        self.assertEqual(
            repr(notification.subject),
            'NotificationSubject(title="Feature/coveralls")',
        )

    def testGetNotifications(self):
        self.assertListKeyEqual(
            self.user.get_notifications(participating=True),
            lambda n: n.id,
            ["8406712"],
        )
    ...
    def testGetNotificationsWithOtherArguments(self):
        self.assertListKeyEqual(
            self.user.get_notifications(all=True),
            lambda n: n.id,
            [],
        )
    ...
    def testGetInvitations(self):
        ...
        self.assertEqual(
            invitation.html_url,
            "https://github.com/jacquev6/PyGithub/invitations",
        )
    ...
    def testCreateMigration(self):
        self.assertTrue(
            isinstance(
                self.user.create_migration(["sample-repo"]),
